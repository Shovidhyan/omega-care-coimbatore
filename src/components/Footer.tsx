      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-primary/10 hover:bg-primary flex items-center justify-center transition-smooth hover:text-primary-foreground"
              >
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-muted-foreground">
                  17/5, Lakshmipuram 1st Street, Coimbatore - 641045
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                <div className="text-sm">
                  <a href="tel:+919342036924" className="text-muted-foreground hover:text-primary transition-smooth block">
                    +91 93420 36924
                  </a>
                  <a href="tel:+918072790044" className="text-muted-foreground hover:text-primary transition-smooth block">
                    +91 80727 90044
                  </a>
                </div>
              </li>
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:johnbosco2882@gmail.com" className="text-sm text-muted-foreground hover:text-primary transition-smooth">
        ...
        <div className="border-t border-border mt-8 pt-6 text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Omega Home Nursing Care. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
